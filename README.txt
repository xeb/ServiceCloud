The ServiceCloud is a prototype of a custom Service Host with many WCF services.  Each of these services is accessible on their own.  There exists a Gateway service that accepts requests to call any of the ICloudService(s) in a specific order.  This allows you to call many WCF services with 1 client call.  
